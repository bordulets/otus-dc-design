...
vpc domain 1
  ...
  virtual peer-link destination 10.11.0.2 source 10.11.0.1 dscp 56
  delay restore 60
  peer-gateway
  layer3 peer-router
  auto-recovery
...
interface loopback0
 ...
 ip address 10.10.0.254/32 secondary
...
vpc domain 1
  ...
  virtual peer-link destination 10.11.0.1 source 10.11.0.2 dscp 56
  delay restore 60
  peer-gateway
  layer3 peer-router
  auto-recovery
...
interface loopback0
 ...
 ip address 10.10.0.253/32 secondary
